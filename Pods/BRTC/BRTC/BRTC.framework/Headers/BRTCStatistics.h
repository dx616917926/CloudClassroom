/*
 * Module:   BRTCStatistics
 *
 * Function: BRTC的质量统计相关接口
 *
 */
...
/// 本地的音视频统计信息
@interface BRTCLocalStatistics : NSObject
...
/// 远端成员的音视频统计信息
@interface BRTCRemoteStatistics : NSObject
...
/// 统计数据
@interface BRTCStatistics : NSObject
...
/// 当前 CPU 使用率（％）
@property (nonatomic, assign) uint32_t  cpu;
...
@property (nonatomic, strong) NSArray<BRTCLocalStatistics*>*  localStatistics;

/// 远端成员的音视频统计信息，可能有主画面、小画面以及辅路画面等多路的情况，因此是一个数组
@property (nonatomic, strong) NSArray<BRTCRemoteStatistics*>* remoteStatistics;
