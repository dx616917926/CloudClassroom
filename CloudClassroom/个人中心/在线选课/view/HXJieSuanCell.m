...
-(void)setOrderDetailInfoModel:(HXOrderDetailInfoModel *)orderDetailInfoModel{
    ...
    [self.xueQiBtn setTitle:[NSString stringWithFormat:@"第%@学期",orderDetailInfoModel.term] forState:UIControlStateNormal];
    self.titleLabel.text = orderDetailInfoModel.termCourseName;
    NSString *content = [NSString stringWithFormat:@"￥%.2f",orderDetailInfoModel.price];
    NSArray *tempArray = [HXFloatToString(orderDetailInfoModel.price) componentsSeparatedByString:@"."];
