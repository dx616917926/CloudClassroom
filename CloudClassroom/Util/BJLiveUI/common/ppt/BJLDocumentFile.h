...
typedef NS_ENUM(NSInteger, BJLDocumentFileType) {
    ...
    BJLDocumentFileWebLink, // 网页链接课件
    BJLDocumentFileBDS, // 黑板导出文件
...
@property (nonatomic, nullable) NSString *localID; // 文档标识符, 远端文档为nil
@property (nonatomic) NSString *remoteID; // 远端文档 ID
...
@property (nonatomic, nullable) NSURL *localPathURL; // 本地上传文档的路径,可以为空,便于重传
...
@property (nonatomic, nullable) UIDocument *localDocument; // 本地文档, 远端文档此属性为nil
@property (nonatomic, nullable) BJLDocument *remoteDocument; // 远端文档, 本地文档此属性为nil
...
@property (nonatomic, nullable) BJLHomework *remoteHomework; // 远端作业
...
@property (nonatomic, nullable) BJLCloudFile *remoteCloudFile; // 远端云盘文档
...
@property (nonatomic, nullable) BJLMediaFile *remoteMediaFile;
