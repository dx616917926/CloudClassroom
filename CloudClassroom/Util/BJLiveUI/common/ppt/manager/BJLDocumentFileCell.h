...
typedef NS_ENUM(NSInteger, BJLDocumentFileCellType) {
    BJLDocumentFileCellTypeDocument,
    BJLDocumentFileCellTypeCloud,
    BJLDocumentFileCellTypeHomework,
};

@interface BJLDocumentFileCell: UITableViewCell
