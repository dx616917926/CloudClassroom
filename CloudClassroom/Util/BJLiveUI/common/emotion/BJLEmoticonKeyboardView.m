...
- (instancetype)initForIdiomPad:(BOOL)iPad {
    if (self = [super initWithFrame:CGRectZero]) {
        ...
        self.pageControl = ({
            ...
            pageControl.pageIndicatorTintColor = BJLTheme.toolButtonTitleColor;
            pageControl.currentPageIndicatorTintColor = BJLTheme.brandColor;
            [self addSubview:pageControl];
            [pageControl bjl_makeConstraints:^(BJLConstraintMaker *make) {
                make.centerX.equalTo(self.bjl_safeAreaLayoutGuide ?: self);
                make.bottom.equalTo(self.bjl_safeAreaLayoutGuide ?: self).with.offset(-5.0);
...
- (UICollectionViewFlowLayout *)makeLayout {
    ...
    return ({
        ...
        layout.sectionInset = UIEdgeInsetsMake(verMargin, horMargin, verMargin, horMargin);
