...
- (void)configureWithRank:(NSInteger)rank userName:(nullable NSString *)userName score:(NSInteger)score {
    ...
    switch (rank) {
        case 1:
            self.rankImageView.image = [UIImage bjl_imageNamed:@"bjl_envelope_first"];
            break;

        case 2:
            self.rankImageView.image = [UIImage bjl_imageNamed:@"bjl_envelope_second"];
            break;

        case 3:
            self.rankImageView.image = [UIImage bjl_imageNamed:@"bjl_envelope_third"];
            break;
