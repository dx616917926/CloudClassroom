...
#define BJLScVideoPlaceholderViewOverlayImageMinSize 32.0
#define BJLScVideoPlaceholderViewOverlayImageMaxSize 480.0
#define BJLScVideoPlaceholderViewViewSpaceM          10.0
...
- (void)makeSubviewAndConstraintsWithImage:(UIImage *)image tip:(NSString *)tip {
    ...
    self.imageView = ({
        ...
        [imageView bjl_makeConstraints:^(BJLConstraintMaker *_Nonnull make) {
            ...
            make.centerY.equalTo(self).offset(-BJLScVideoPlaceholderViewViewSpaceM);
            make.height.equalTo(self).multipliedBy(0.5);
            make.width.equalTo(imageView.bjl_height);
            make.height.width.lessThanOrEqualTo(@(BJLScVideoPlaceholderViewOverlayImageMaxSize)).priorityHigh();
            make.height.width.greaterThanOrEqualTo(@(BJLScVideoPlaceholderViewOverlayImageMinSize)).priorityHigh();
        }];
