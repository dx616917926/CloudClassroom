...
@class BJLYYTextAsyncLayerDisplayTask;

NS_ASSUME_NONNULL_BEGIN

/**
 The BJLYYTextAsyncLayer class is a subclass of CALayer used for render contents asynchronously.
 ...
 */
@interface BJLYYTextAsyncLayer: CALayer
/// Whether the render code is executed in background. Default is YES.
@property BOOL displaysAsynchronously;
@end

/**
 The BJLYYTextAsyncLayer's delegate protocol. The delegate of the BJLYYTextAsyncLayer (typically a UIView)
 must implements the method in this protocol.
 */
@protocol BJLYYTextAsyncLayerDelegate <NSObject>
@required
...
/**
 A display task used by BJLYYTextAsyncLayer to render the contents in background queue.
 */
@interface BJLYYTextAsyncLayerDisplayTask: NSObject
