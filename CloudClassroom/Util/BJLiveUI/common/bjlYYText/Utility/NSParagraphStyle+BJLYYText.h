 ...
 */
@interface NSParagraphStyle (BJLYYText)
 ...
 */
+ (nullable NSParagraphStyle *)bjlyy_styleWithCTStyle:(CTParagraphStyleRef)CTStyle;

/**
 Creates and returns a CoreText Paragraph Style. (need call CFRelease() after used)
 */
- (nullable CTParagraphStyleRef)bjlyy_CTStyle CF_RETURNS_RETAINED;
