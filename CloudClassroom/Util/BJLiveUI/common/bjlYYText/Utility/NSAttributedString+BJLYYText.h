//
//  NSAttributedString+BJLYYText.h
 ...
 */
@interface NSAttributedString (BJLYYText)

/**
 Archive the string to data.
 @return Returns nil if an error occurs.
 */
- (nullable NSData *)bjlyy_archiveToData;
...
/**
 ...
 @return Returns nil if an error occurs.
 */
+ (nullable instancetype)bjlyy_unarchiveFromData:(NSData *)data;
 ...
 */
@property (nullable, nonatomic, copy, readonly) NSDictionary<NSString *, id> *bjlyy_attributes;
 ...
 */
- (nullable NSDictionary<NSString *, id> *)bjlyy_attributesAtIndex:(NSUInteger)index;
 ...
 */
- (nullable id)bjlyy_attribute:(NSString *)attributeName atIndex:(NSUInteger)index;
 ...
 */
@property (nullable, nonatomic, strong, readonly) UIFont *bjlyy_font;
- (nullable UIFont *)bjlyy_fontAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *bjlyy_kern;
- (nullable NSNumber *)bjlyy_kernAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *bjlyy_color;
- (nullable UIColor *)bjlyy_colorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *bjlyy_backgroundColor;
- (nullable UIColor *)bjlyy_backgroundColorAtIndex:(NSUInteger)index;
 ...
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *bjlyy_strokeWidth;
- (nullable NSNumber *)bjlyy_strokeWidthAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *bjlyy_strokeColor;
- (nullable UIColor *)bjlyy_strokeColorAtIndex:(NSUInteger)index;
 ...
 */
@property (nullable, nonatomic, strong, readonly) NSShadow *bjlyy_shadow;
- (nullable NSShadow *)bjlyy_shadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nonatomic, readonly) NSUnderlineStyle bjlyy_strikethroughStyle;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) UIColor *bjlyy_strikethroughColor;
- (nullable UIColor *)bjlyy_strikethroughColorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0
 */
@property (nonatomic, readonly) NSUnderlineStyle bjlyy_underlineStyle;
 ...
 */
@property (nullable, nonatomic, strong, readonly) UIColor *bjlyy_underlineColor;
- (nullable UIColor *)bjlyy_underlineColorAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *bjlyy_ligature;
- (nullable NSNumber *)bjlyy_ligatureAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSString *bjlyy_textEffect;
- (nullable NSString *)bjlyy_textEffectAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *bjlyy_obliqueness;
- (nullable NSNumber *)bjlyy_obliquenessAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *bjlyy_expansion;
- (nullable NSNumber *)bjlyy_expansionAtIndex:(NSUInteger)index;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readonly) NSNumber *bjlyy_baselineOffset;
- (nullable NSNumber *)bjlyy_baselineOffsetAtIndex:(NSUInteger)index;
 ...
 */
@property (nonatomic, readonly) BOOL bjlyy_verticalGlyphForm;
 ...
 */
@property (nullable, nonatomic, strong, readonly) NSString *bjlyy_language;
- (nullable NSString *)bjlyy_languageAtIndex:(NSUInteger)index;
 ...
 */
@property (nullable, nonatomic, strong, readonly) NSArray<NSNumber *> *bjlyy_writingDirection;
- (nullable NSArray<NSNumber *> *)bjlyy_writingDirectionAtIndex:(NSUInteger)index;
 ...
 */
@property (nullable, nonatomic, strong, readonly) NSParagraphStyle *bjlyy_paragraphStyle;
- (nullable NSParagraphStyle *)bjlyy_paragraphStyleAtIndex:(NSUInteger)index;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) NSTextAlignment bjlyy_alignment;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) NSLineBreakMode bjlyy_lineBreakMode;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) CGFloat bjlyy_lineSpacing;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) CGFloat bjlyy_paragraphSpacing;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) CGFloat bjlyy_paragraphSpacingBefore;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) CGFloat bjlyy_firstLineHeadIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) CGFloat bjlyy_headIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) CGFloat bjlyy_tailIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) CGFloat bjlyy_minimumLineHeight;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) CGFloat bjlyy_maximumLineHeight;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) CGFloat bjlyy_lineHeightMultiple;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readonly) NSWritingDirection bjlyy_baseWritingDirection;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nonatomic, readonly) float bjlyy_hyphenationFactor;
 ...
 */
@property (nonatomic, readonly) CGFloat bjlyy_defaultTabInterval;
...
/**
 ...
 @since CoreText:7.0  UIKit:7.0  YYText:7.0
 */
@property (nullable, nonatomic, copy, readonly) NSArray<NSTextTab *> *bjlyy_tabStops;
- (nullable NSArray<NSTextTab *> *)bjlyy_tabStopsAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readonly) BJLYYTextShadow *bjlyy_textShadow;
- (nullable BJLYYTextShadow *)bjlyy_textShadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readonly) BJLYYTextShadow *bjlyy_textInnerShadow;
- (nullable BJLYYTextShadow *)bjlyy_textInnerShadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readonly) BJLYYTextDecoration *bjlyy_textUnderline;
- (nullable BJLYYTextDecoration *)bjlyy_textUnderlineAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readonly) BJLYYTextDecoration *bjlyy_textStrikethrough;
- (nullable BJLYYTextDecoration *)bjlyy_textStrikethroughAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readonly) BJLYYTextBorder *bjlyy_textBorder;
- (nullable BJLYYTextBorder *)bjlyy_textBorderAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readonly) BJLYYTextBorder *bjlyy_textBackgroundBorder;
- (nullable BJLYYTextBorder *)bjlyy_textBackgroundBorderAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYText:6.0
 */
@property (nonatomic, readonly) CGAffineTransform bjlyy_textGlyphTransform;
...
/**
 ...
 If there's `BJLYYTextBackedStringAttributeName` attribute, the backed string will
 replace the attributed string range.
 
 @param range A range in receiver.
 @return The plain text.
 */
- (nullable NSString *)bjlyy_plainTextForRange:(NSRange)range;
...
/**
 ...
 @since YYText:6.0
 */
+ (NSMutableAttributedString *)bjlyy_attachmentStringWithContent:(nullable id)content
...
/**
 ...
 @since YYText:6.0
 */
+ (nullable NSMutableAttributedString *)bjlyy_attachmentStringWithEmojiImage:(UIImage *)image
 ...
 */
- (void)bjlyy_setAttributes:(nullable NSDictionary<NSString *, id> *)attributes;
- (void)setBjlyy_attributes:(nullable NSDictionary<NSString *, id> *)attributes;
 ...
 */
- (void)bjlyy_setAttribute:(NSString *)name value:(nullable id)value;
 ...
 */
- (void)bjlyy_setAttribute:(NSString *)name value:(nullable id)value range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIFont *bjlyy_font;
- (void)bjlyy_setFont:(nullable UIFont *)font range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *bjlyy_kern;
- (void)bjlyy_setKern:(nullable NSNumber *)kern range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *bjlyy_color;
- (void)bjlyy_setColor:(nullable UIColor *)color range:(NSRange)range;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *bjlyy_backgroundColor;
- (void)bjlyy_setBackgroundColor:(nullable UIColor *)backgroundColor range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *bjlyy_strokeWidth;
- (void)bjlyy_setStrokeWidth:(nullable NSNumber *)strokeWidth range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *bjlyy_strokeColor;
- (void)bjlyy_setStrokeColor:(nullable UIColor *)strokeColor range:(NSRange)range;
...
/**
 ...
 @since UIKit:6.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSShadow *bjlyy_shadow;
- (void)bjlyy_setShadow:(nullable NSShadow *)shadow range:(NSRange)range;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nonatomic, readwrite) NSUnderlineStyle bjlyy_strikethroughStyle;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *bjlyy_strikethroughColor;
- (void)bjlyy_setStrikethroughColor:(nullable UIColor *)strikethroughColor range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0
 */
@property (nonatomic, readwrite) NSUnderlineStyle bjlyy_underlineStyle;
...
/**
 ...
 @since CoreText:3.2  UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) UIColor *bjlyy_underlineColor;
- (void)bjlyy_setUnderlineColor:(nullable UIColor *)underlineColor range:(NSRange)range;
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *bjlyy_ligature;
- (void)bjlyy_setLigature:(nullable NSNumber *)ligature range:(NSRange)range;
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) NSString *bjlyy_textEffect;
- (void)bjlyy_setTextEffect:(nullable NSString *)textEffect range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *bjlyy_obliqueness;
- (void)bjlyy_setObliqueness:(nullable NSNumber *)obliqueness range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *bjlyy_expansion;
- (void)bjlyy_setExpansion:(nullable NSNumber *)expansion range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since UIKit:7.0
 */
@property (nullable, nonatomic, strong, readwrite) NSNumber *bjlyy_baselineOffset;
- (void)bjlyy_setBaselineOffset:(nullable NSNumber *)baselineOffset range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since CoreText:4.3  YYText:6.0
 */
@property (nonatomic, readwrite) BOOL bjlyy_verticalGlyphForm;
...
/**
 ...
 @since CoreText:7.0  YYText:7.0
 */
@property (nullable, nonatomic, strong, readwrite) NSString *bjlyy_language;
- (void)bjlyy_setLanguage:(nullable NSString *)language range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since CoreText:6.0  UIKit:7.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSArray<NSNumber *> *bjlyy_writingDirection;
- (void)bjlyy_setWritingDirection:(nullable NSArray<NSNumber *> *)writingDirection range:(NSRange)range;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) NSParagraphStyle *bjlyy_paragraphStyle;
- (void)bjlyy_setParagraphStyle:(nullable NSParagraphStyle *)paragraphStyle range:(NSRange)range;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) NSTextAlignment bjlyy_alignment;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) NSLineBreakMode bjlyy_lineBreakMode;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) CGFloat bjlyy_lineSpacing;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) CGFloat bjlyy_paragraphSpacing;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) CGFloat bjlyy_paragraphSpacingBefore;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) CGFloat bjlyy_firstLineHeadIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) CGFloat bjlyy_headIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) CGFloat bjlyy_tailIndent;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) CGFloat bjlyy_minimumLineHeight;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) CGFloat bjlyy_maximumLineHeight;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) CGFloat bjlyy_lineHeightMultiple;
...
/**
 ...
 @since CoreText:6.0  UIKit:6.0  YYText:6.0
 */
@property (nonatomic, readwrite) NSWritingDirection bjlyy_baseWritingDirection;
...
/**
 ...
 @since UIKit:6.0
 */
@property (nonatomic, readwrite) float bjlyy_hyphenationFactor;
...
/**
 ...
 @since CoreText:7.0  UIKit:7.0  YYText:7.0
 */
@property (nonatomic, readwrite) CGFloat bjlyy_defaultTabInterval;
- (void)bjlyy_setDefaultTabInterval:(CGFloat)defaultTabInterval range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since CoreText:7.0  UIKit:7.0  YYText:7.0
 */
@property (nullable, nonatomic, copy, readwrite) NSArray<NSTextTab *> *bjlyy_tabStops;
- (void)bjlyy_setTabStops:(nullable NSArray<NSTextTab *> *)tabStops range:(NSRange)range NS_AVAILABLE_IOS(7_0);
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) BJLYYTextShadow *bjlyy_textShadow;
- (void)bjlyy_setTextShadow:(nullable BJLYYTextShadow *)textShadow range:(NSRange)range;
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) BJLYYTextShadow *bjlyy_textInnerShadow;
- (void)bjlyy_setTextInnerShadow:(nullable BJLYYTextShadow *)textInnerShadow range:(NSRange)range;
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) BJLYYTextDecoration *bjlyy_textUnderline;
- (void)bjlyy_setTextUnderline:(nullable BJLYYTextDecoration *)textUnderline range:(NSRange)range;
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) BJLYYTextDecoration *bjlyy_textStrikethrough;
- (void)bjlyy_setTextStrikethrough:(nullable BJLYYTextDecoration *)textStrikethrough range:(NSRange)range;
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) BJLYYTextBorder *bjlyy_textBorder;
- (void)bjlyy_setTextBorder:(nullable BJLYYTextBorder *)textBorder range:(NSRange)range;
...
/**
 ...
 @since YYText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) BJLYYTextBorder *bjlyy_textBackgroundBorder;
- (void)bjlyy_setTextBackgroundBorder:(nullable BJLYYTextBorder *)textBackgroundBorder range:(NSRange)range;
...
/**
 ...
 @since YYText:6.0
 */
@property (nonatomic, readwrite) CGAffineTransform bjlyy_textGlyphTransform;
...
- (void)bjlyy_setSuperscript:(nullable NSNumber *)superscript range:(NSRange)range;
- (void)bjlyy_setGlyphInfo:(nullable CTGlyphInfoRef)glyphInfo range:(NSRange)range;
- (void)bjlyy_setCharacterShape:(nullable NSNumber *)characterShape range:(NSRange)range;
- (void)bjlyy_setRunDelegate:(nullable CTRunDelegateRef)runDelegate range:(NSRange)range;
- (void)bjlyy_setBaselineClass:(nullable CFStringRef)baselineClass range:(NSRange)range;
- (void)bjlyy_setBaselineInfo:(nullable CFDictionaryRef)baselineInfo range:(NSRange)range;
- (void)bjlyy_setBaselineReferenceInfo:(nullable CFDictionaryRef)referenceInfo range:(NSRange)range;
- (void)bjlyy_setRubyAnnotation:(nullable CTRubyAnnotationRef)ruby range:(NSRange)range NS_AVAILABLE_IOS(8_0);
- (void)bjlyy_setAttachment:(nullable NSTextAttachment *)attachment range:(NSRange)range NS_AVAILABLE_IOS(7_0);
- (void)bjlyy_setLink:(nullable id)link range:(NSRange)range NS_AVAILABLE_IOS(7_0);
- (void)bjlyy_setTextBackedString:(nullable BJLYYTextBackedString *)textBackedString range:(NSRange)range;
- (void)bjlyy_setTextBinding:(nullable BJLYYTextBinding *)textBinding range:(NSRange)range;
- (void)bjlyy_setTextAttachment:(nullable BJLYYTextAttachment *)textAttachment range:(NSRange)range;
- (void)bjlyy_setTextHighlight:(nullable BJLYYTextHighlight *)textHighlight range:(NSRange)range;
- (void)bjlyy_setTextBlockBorder:(nullable BJLYYTextBorder *)textBlockBorder range:(NSRange)range;
- (void)bjlyy_setTextRubyAnnotation:(nullable BJLYYTextRubyAnnotation *)ruby range:(NSRange)range NS_AVAILABLE_IOS(8_0);
...
- (void)bjlyy_setTextHighlightRange:(NSRange)range
                    ...
                    backgroundColor:(nullable UIColor *)backgroundColor
                          ...
                          tapAction:(nullable BJLYYTextAction)tapAction
                    longPressAction:(nullable BJLYYTextAction)longPressAction;
 ...
 */
+ (NSArray<NSString *> *)bjlyy_allDiscontinuousAttributeKeys;
