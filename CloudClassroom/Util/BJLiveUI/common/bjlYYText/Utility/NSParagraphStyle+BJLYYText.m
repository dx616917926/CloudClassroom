...
@interface NSParagraphStyle_BJLYYText: NSObject
@end
@implementation NSParagraphStyle_BJLYYText
@end

@implementation NSParagraphStyle (BJLYYText)

+ (NSParagraphStyle *)bjlyy_styleWithCTStyle:(CTParagraphStyleRef)CTStyle {
...
- (CTParagraphStyleRef)bjlyy_CTStyle CF_RETURNS_RETAINED {
