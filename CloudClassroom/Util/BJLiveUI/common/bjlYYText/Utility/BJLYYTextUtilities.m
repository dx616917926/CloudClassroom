...
CGAffineTransform BJLYYTextCGAffineTransformGetFromPoints(CGPoint before[3], CGPoint after[3]) {
...
CGAffineTransform BJLYYTextCGAffineTransformGetFromViews(UIView *from, UIView *to) {
    ...
    after[0] = [from bjlyy_convertPoint:before[0] toViewOrWindow:to];
    after[1] = [from bjlyy_convertPoint:before[1] toViewOrWindow:to];
    after[2] = [from bjlyy_convertPoint:before[2] toViewOrWindow:to];

    return BJLYYTextCGAffineTransformGetFromPoints(before, after);
}
...
UIApplication *BJLYYTextSharedApplication(void) {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
    return BJLYYTextIsAppExtension() ? nil : [UIApplication performSelector:@selector(sharedApplication)];
