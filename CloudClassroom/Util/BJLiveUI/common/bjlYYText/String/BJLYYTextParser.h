...
/**
 The BJLYYTextParser protocol declares the required method for YYTextView and YYLabel
 to modify the text during editing.
 
 You can implement this protocol to add code highlighting or emoticon replacement for
 YYTextView and YYLabel. See `BJLYYTextSimpleMarkdownParser` and `BJLYYTextSimpleEmoticonParser` for example.
 */
@protocol BJLYYTextParser <NSObject>
@required
/**
 ...
 */
@interface BJLYYTextSimpleMarkdownParser: NSObject <BJLYYTextParser>
 ...
 */
@interface BJLYYTextSimpleEmoticonParser: NSObject <BJLYYTextParser>
