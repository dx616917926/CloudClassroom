 ...
 */
@interface BJLYYTextArchiver: NSKeyedArchiver <NSKeyedArchiverDelegate>
@end
...
/**
 ...
 `BJLYYTextArchiver` or `NSKeyedArchiver`.
 */
@interface BJLYYTextUnarchiver: NSKeyedUnarchiver <NSKeyedUnarchiverDelegate>
@end
