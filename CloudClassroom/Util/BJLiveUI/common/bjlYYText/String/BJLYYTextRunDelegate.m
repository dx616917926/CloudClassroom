...
static void DeallocCallback(void *ref) {
    BJLYYTextRunDelegate *self = (__bridge_transfer BJLYYTextRunDelegate *)(ref);
    self = nil; // release
}

static CGFloat GetAscentCallback(void *ref) {
    BJLYYTextRunDelegate *self = (__bridge BJLYYTextRunDelegate *)(ref);
    return self.ascent;
}
...
@implementation BJLYYTextRunDelegate
