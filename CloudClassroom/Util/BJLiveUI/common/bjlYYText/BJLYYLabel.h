...
/**
 The BJLYYLabel class implements a read-only text view.
 ...
 * It supports vertical form layout to display CJK text.
 ...
 See YYTextAttribute.h and BJLYYTextLayout.h for more information.
 */
@interface BJLYYLabel: UIView <NSCoding>
...
/**
 The text vertical aligmnent in container. Default is BJLYYTextVerticalAlignmentCenter.
 */
@property (nonatomic) BJLYYTextVerticalAlignment textVerticalAlignment;
...
/**
 ...
 See `BJLYYTextParser` protocol for more information.
 */
@property (nullable, nonatomic, strong) id<BJLYYTextParser> textParser;
 ...
 */
@property (nullable, nonatomic, strong) BJLYYTextLayout *textLayout;
...
/**
 ...
 See `BJLYYTextLinePositionModifier` protocol for more information.
 */
@property (nullable, nonatomic, copy) id<BJLYYTextLinePositionModifier> linePositionModifier;

/**
 The debug option to display CoreText layout result.
 The default value is [BJLYYTextDebugOption sharedDebugOption].
 */
@property (nullable, nonatomic, copy) BJLYYTextDebugOption *debugOption;
...
/**
 ...
 The default value is nil.
 */
@property (nullable, nonatomic, copy) BJLYYTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, copy) BJLYYTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) BJLYYTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil. 
 */
@property (nullable, nonatomic, copy) BJLYYTextAction highlightLongPressAction;
...
/*
 ...
 3. If you want to get the highest performance, you should do text layout with
    `BJLYYTextLayout` class in background thread. Here's an example:
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        text.bjlyy_font = [UIFont systemFontOfSize:16];
        text.bjlyy_color = [UIColor grayColor];
        [text yy_setColor:[UIColor redColor] range:NSMakeRange(0, 4)];
 
        // Create text container
        BJLYYTextContainer *container = [BJLYYTextContainer new];
        container.size = CGSizeMake(100, CGFLOAT_MAX);
        container.maximumNumberOfRows = 0;
        
        // Generate a text layout.
        BJLYYTextLayout *layout = [BJLYYTextLayout layoutWithContainer:container text:text];
...
@property (nonatomic) UIEdgeInsets textContainerInset;
@property (nullable, nonatomic, copy) id<BJLYYTextLinePositionModifier> linePositionModifier;
@property (nonnull, nonatomic, copy) BJLYYTextDebugOption *debugOption;
@property (nullable, nonatomic, copy) BJLYYTextAction textTapAction;
@property (nullable, nonatomic, copy) BJLYYTextAction textLongPressAction;
@property (nullable, nonatomic, copy) BJLYYTextAction highlightTapAction;
@property (nullable, nonatomic, copy) BJLYYTextAction highlightLongPressAction;
