...
- (void)reloadBounds {
    ...
    for (NSUInteger r = 0; r < runCount; r++) {
        ...
        BJLYYTextAttachment *attachment = attrs[BJLYYTextAttachmentAttributeName];
        if (attachment) {
            ...
            NSRange runRange = BJLYYTextNSRangeFromCFRange(CTRunGetStringRange(run));
