...
@class BJLYYTextDebugOption;

NS_ASSUME_NONNULL_BEGIN

/**
 The BJLYYTextDebugTarget protocol defines the method a debug target should implement.
 A debug target can be add to the global container to receive the shared debug
 option changed notification.
 */
@protocol BJLYYTextDebugTarget <NSObject>
 ...
 */
- (void)setDebugOption:(nullable BJLYYTextDebugOption *)option;
@end

/**
 The debug option for YYText.
 */
@interface BJLYYTextDebugOption: NSObject <NSCopying>
 ...
 */
+ (nullable BJLYYTextDebugOption *)sharedDebugOption;
 ...
 */
+ (void)setSharedDebugOption:(nullable BJLYYTextDebugOption *)option;
