...
@implementation BJLWindowBottomBar
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self->_resizeHandleView = ({
            ...
            view.accessibilityIdentifier = BJLKeypath(self, resizeHandleView);
        ...
        self->_resizeHandleImageView = ({
            UIImageView *imageView = [UIImageView new];
            imageView.image = [UIImage bjl_imageNamed:@"window_triangle"];
        ...
        [self.resizeHandleView bjl_makeConstraints:^(BJLConstraintMaker *make) {
            ...
            make.width.height.equalTo(@(BJLAppearance.userWindowDefaultBarHeight));
        }];
