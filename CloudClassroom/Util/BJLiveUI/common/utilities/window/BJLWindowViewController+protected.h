//
//  BJLWindowViewController+protected.h
//  BJLiveUI
//
...
@property (nonatomic) BOOL topBarHidden, bottomBarHidden; // default: NO
...
@property (nonatomic, readonly) BJLWindowTopBar *topBar;
@property (nonatomic, readonly) BJLWindowBottomBar *bottomBar;

@property (nonatomic) NSMutableArray<UIGestureRecognizer *> *windowGestures;
@property (nonatomic) BOOL windowGesturesEnabled;

@end

@interface BJLWindowViewController (protected)
