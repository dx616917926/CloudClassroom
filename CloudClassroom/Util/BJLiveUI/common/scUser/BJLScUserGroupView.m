...
- (void)makeSubViews {
    ...
    self.openButton = ({
        ...
        button.accessibilityIdentifier = BJLKeypath(self, openButton);
    ...
    self.groupColorButton = ({
        ...
        button.accessibilityIdentifier = BJLKeypath(self, groupColorButton);
    ...
    self.userNumberLabel = ({
        UILabel *label = [UILabel new];
        label.accessibilityIdentifier = BJLKeypath(self, userNumberLabel);
