...
- (void)makeSubviewsAndConstraints {
    ...
    self.cancelStickyButton = ({
        ...
        button.hidden = YES;
        [button setTitle:BJLLocalizedString(@"取消置顶") forState:UIControlStateNormal];
...
- (void)updateWithMessage:(BJLMessage *)message isStickyMessage:(BOOL)isStickyMessage {
    ...
    if (message.fromUser.isTeacherOrAssistant) {
        NSString *roleString = message.fromUser.isTeacher ? BJLLocalizedString(@"老师") : BJLLocalizedString(@"助教");
