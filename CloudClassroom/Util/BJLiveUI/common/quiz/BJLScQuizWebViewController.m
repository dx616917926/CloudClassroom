...
- (void)viewDidLoad {
    ...
    UILabel *label = ({
        ...
        label.text = BJLLocalizedString(@"测验");
    ...
    [label bjl_makeConstraints:^(BJLConstraintMaker *_Nonnull make) {
        make.left.equalTo(self.topView.bjl_safeAreaLayoutGuide ?: self.topView).with.offset(15.0);
    ...
    [line bjl_makeConstraints:^(BJLConstraintMaker *_Nonnull make) {
        ...
        make.left.equalTo(self.topView.bjl_safeAreaLayoutGuide ?: self.topView).with.offset(15.0);
        make.right.equalTo(self.topView.bjl_safeAreaLayoutGuide ?: self.topView).with.offset(-15.0);
    ...
    [self.closeButton bjl_addHandler:^(__kindof UIControl *_Nullable sender) {
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:BJLLocalizedString(@"提示")
                                                                       message:BJLLocalizedString(@"确认关闭测验？")
