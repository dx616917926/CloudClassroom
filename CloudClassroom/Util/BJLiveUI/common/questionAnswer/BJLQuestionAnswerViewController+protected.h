//
//  BJLQuestionAnswerViewController+protected.h
//  BJLiveUI
//
...
@interface BJLQuestionAnswerViewController ()
...
@property (nonatomic) UILabel *participatedNumberLabel, *correctRateLabel, *correctAnswerLabel, *answerLabel;
