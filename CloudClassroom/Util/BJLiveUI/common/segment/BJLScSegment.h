...
- (instancetype)initWithItems:(NSArray<NSString *> *)items width:(CGFloat)width fontSize:(CGFloat)fontSize textColor:(UIColor *)textColor style:(BJLSegmentStyle)style;
