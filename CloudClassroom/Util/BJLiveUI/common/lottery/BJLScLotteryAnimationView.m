...
- (void)startEggDownAnimation {
    ...
    self.eggDownImageView = ({
        UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage bjl_imageNamed:@"bjl_sc_lottery_down"]];
        imageView.accessibilityIdentifier = BJLKeypath(self, eggDownImageView);
...
- (void)makeEggTimeView {
    self.eggImageView = [[UIImageView alloc] initWithImage:[UIImage bjl_imageNamed:@"bjl_sc_lottery_time"]];
    self.eggImageView.accessibilityIdentifier = BJLKeypath(self, eggImageView);
    ...
    self.countLabel = ({
        ...
        label.accessibilityIdentifier = BJLKeypath(self, countLabel);
...
- (void)countDown {
    ...
    if (self.count > 0) {
        ...
        self.eggImageView.image = [UIImage bjl_imageNamed:@"bjl_sc_lottery_boom"];
