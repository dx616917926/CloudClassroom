...
- (void)updateViewWithLottery:(BJLLottery *)lottery status:(BJLScLotteryViewStatus)status {
    ...
    switch (status) {
        ...
        case BJLScLotteryViewStatus_Submit:
            self.titleImageView.image = [UIImage bjl_imageNamed:@"bjl_sc_lottery_win"];
            self.winDescribeLabel.text = BJLLocalizedString(@"请在下方输入联系方式方便工作人员与您取得联系～");
        ...
        case BJLScLotteryViewStatus_Fill:
            self.titleImageView.image = [UIImage bjl_imageNamed:@"bjl_sc_lottery_result_img"];
            self.winDescribeLabel.text = BJLLocalizedString(@"恭喜以下用户获得了幸运抽奖礼品～");
            self.winDescribeLabel.hidden = NO;
        ...
        case BJLScLotteryViewStatus_Lose:
            self.titleImageView.image = [UIImage bjl_imageNamed:@"bjl_sc_lottery_lose"];
...
- (void)makeCommonSubviews {
    ...
    self.titleImageView = ({
        ...
        imageView.accessibilityIdentifier = BJLKeypath(self, titleImageView);
    ...
    self.closeButton = ({
        ...
        [button setImage:[UIImage bjl_imageNamed:@"bjl_sc_lottery_close_normal"] forState:UIControlStateNormal];
        [button setImage:[UIImage bjl_imageNamed:@"bjl_sc_lottery_close_select"] forState:UIControlStateHighlighted];
...
- (void)makeOtherSubviews {
    ...
    self.loseDescribeLabel = ({
        ...
        label.font = [UIFont systemFontOfSize:14.0];
        label.textAlignment = NSTextAlignmentCenter;
        label.text = BJLLocalizedString(@"非常遗憾，本次没有中奖 ～");
        [self.contentView addSubview:label];
        label;
    });
    ...
    self.noLotteryLabel = ({
        ...
        label.font = [UIFont systemFontOfSize:14.0];
        label.textAlignment = NSTextAlignmentCenter;
        label.text = BJLLocalizedString(@"暂无中奖记录");
        [self.contentView addSubview:label];
        label;
    });

    self.doneButton = [self makeButtonWithImageName:@"bjl_sc_lottery_done" isWidth1_4:YES accessibilityIdentifier:BJLKeypath(self, doneButton)];
    self.submitButton = [self makeButtonWithImageName:@"bjl_sc_lottery_submit" isWidth1_4:YES accessibilityIdentifier:BJLKeypath(self, submitButton)];
    self.fillButton = [self makeButtonWithImageName:@"bjl_sc_lottery_fill" isWidth1_4:NO accessibilityIdentifier:BJLKeypath(self, fillButton)];
    self.watchResultButton = [self makeButtonWithImageName:@"bjl_sc_lottery_result_icon" isWidth1_4:NO accessibilityIdentifier:BJLKeypath(self, watchResultButton)];
    ...
    self.nameTextField = ({
        BJLScLotteryTextField *textField = [[BJLScLotteryTextField alloc] initWithPlaceholder:BJLLocalizedString(@"姓名：")];
    ...
    self.phoneTextField = ({
        BJLScLotteryTextField *textField = [[BJLScLotteryTextField alloc] initWithPlaceholder:BJLLocalizedString(@"手机号：")];
    ...
    self.listButton = ({
        ...
        button.hidden = YES;
        [button setTitle:BJLLocalizedString(@"中奖名单") forState:UIControlStateNormal];
    ...
    self.loseImageView = [[UIImageView alloc] initWithImage:[UIImage bjl_imageNamed:@"bjl_sc_lottery_lose_emoji"]];
...
- (UIButton *)makeButtonWithImageName:(NSString *)imageName isWidth1_4:(BOOL)isWidth1_4 accessibilityIdentifier:(NSString *)accessibilityIdentifier {
    BJLImageButton *button = [BJLImageButton buttonWithType:UIButtonTypeCustom];
    [button setImage:[UIImage bjl_imageNamed:@"bjl_sc_lottery_normal"] forState:UIControlStateNormal];
    [button setImage:[UIImage bjl_imageNamed:@"bjl_sc_lottery_select"] forState:UIControlStateHighlighted];
    button.hidden = YES;
    button.accessibilityIdentifier = accessibilityIdentifier;
    [button addTarget:self action:@selector(buttonClickAction:) forControlEvents:UIControlEventTouchUpInside];

    UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage bjl_imageNamed:imageName]];
...
- (UIView *)makeTableHeaderView {
    UIView *view = [UIView new];
    UILabel *nameLabel = [self makeLabel:BJLLocalizedString(@"昵称") alignment:NSTextAlignmentLeft];
    UILabel *prizeLabel = [self makeLabel:BJLLocalizedString(@"奖品名称") alignment:NSTextAlignmentRight];
