...
@property (nonatomic) NSMutableArray<BJVMessage *> *allMessages;
@property (nonatomic) NSMutableArray<BJVMessage *> *loadedMessages;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    BJVMessage *message = bjl_as([self.loadedMessages bjl_objectAtIndex:indexPath.row], BJVMessage);
    if (message && message.type == BJVMessageType_image) {
...
- (NSMutableArray<BJVMessage *> *)allMessages {
    if (!_allMessages) {
...
- (NSMutableArray<BJVMessage *> *)loadedMessages {
    if (!_loadedMessages) {
...
- (UITableView *)tableView {
    if (!_tableView) {
        _tableView = ({
            ...
            tableView.estimatedRowHeight = [BJPChatMessageTableViewCell estimatedRowHeightForMessageType:BJVMessageType_text];
            tableView;
        });
    }
    return _tableView;
