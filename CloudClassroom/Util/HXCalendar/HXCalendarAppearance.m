...
@implementation HXCalendarAppearance
+ (instancetype)share{
    static dispatch_once_t onceToken;
    static HXCalendarAppearance *appearance;
    dispatch_once(&onceToken, ^{
        appearance = [HXCalendarAppearance new];
    });
    return  appearance;
}
...
- (void)setDefaultValues{
    ...
    self.weekDayFormat = HXCalendarWeekDayFormatSingle;
