...
typedef NS_ENUM(NSInteger, HXCalendarWeekDayFormat) {
    HXCalendarWeekDayFormatSingle,
    HXCalendarWeekDayFormatShort,
    HXCalendarWeekDayFormatFull
};
@interface HXCalendarAppearance : NSObject
//从星期几开始   8 代表星期天开始
...
// Weekday
@property (assign, nonatomic) HXCalendarWeekDayFormat weekDayFormat;
/// 周  标识 颜色
