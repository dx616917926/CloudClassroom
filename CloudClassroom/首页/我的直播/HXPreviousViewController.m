...
@interface HXPreviousViewController ()<UITableViewDelegate,UITableViewDataSource,HXMyLiveCellDelegate,BJLRoomVCDelegate,BJVRequestTokenDelegate>
...
@implementation HXPreviousViewController
